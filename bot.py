...
# Message handler to handle astrological signs when the user inputs a zodiac sign
...
# Message handler to take care of the date
...
# Message handler that fetches horoscope data from the horoscope API
